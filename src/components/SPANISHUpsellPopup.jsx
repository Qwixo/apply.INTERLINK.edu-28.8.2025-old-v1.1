...
const SPANISHUpsellPopup = ({ onClose, showClose = true }) => {
  return (
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="text-center md:text-left md:flex-1">
            ...
            <p className="text-[#3a6ea5] text-lg md:text-xl font-medium leading-snug mb-4">
              Muchos estudiantes dicen que una charla rápida con Ana, nuestra directora de admisiones, les ayudó a entender todo mucho mejor.
            </p>

            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6">
              Si necesitas orientación sobre programas, visas o los próximos pasos, llena el formulario a continuación y Ana se pondrá en contacto contigo personalmente para ayudarte. 👍🏻
            </p>
              ...
              <button
                onClick={() => {
                  ...
                  if (typeof gtag !== 'undefined') {
                    ...
                    setTimeout(openTab, 1000); // fallback por si se bloquea el callback
                  } else {
                    openTab();
                  }
          ...
          <div className="flex flex-col items-center md:w-auto">
            ...
            <p className="text-xs text-gray-500">Directora de Admisiones</p>
          </div>
        </div>
      </motion.div>
    </div>
...
export default SPANISHUpsellPopup;
