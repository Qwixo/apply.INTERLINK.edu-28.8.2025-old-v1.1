...
<div className="mb-8">
  ...
  <ul className="space-y-2 text-gray-700">
    <li className="flex items-start">
      ...
      <span className="ml-2">
        <span className="font-semibold">Ages 17+</span> who meet U.S. visa and travel eligibility
      </span>
    </li>
    <li className="flex items-start">
      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
...
<div className="mb-8">
  ...
  <ul className="space-y-2 text-gray-700">
    <li className="flex items-start">
      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
      <span className="ml-2">
        <span className="font-semibold">Ages 15+</span> looking to improve English from anywhere
      </span>
    </li>
    <li className="flex items-start">
      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
...
export default V2StudyOptionsSection;
