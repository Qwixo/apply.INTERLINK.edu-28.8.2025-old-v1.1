...
<p className="text-center text-gray-700 text-lg mb-12 max-w-3xl mx-auto">
  Mohamed • Lina Rois • Yuna Minami • Huizi • Jimena • Estephania • Thais • Telma Borges
</p>
...
<div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
  <div className="aspect-video w-full">
    <iframe
      ...
      src="https://www.youtube.com/embed/NEb108hXtio"
      title="Chau Testimonial"
      frameBorder="0"
  ...
  <div className="p-6">
    ...
    <p className="text-gray-700">
      Sau khi học tiếng Anh ở INTERLINK thì tôi đã tốt hơn về mặt giao tiếp và đặc biệt là về viết bài luận. Tôi có thể giao tiếp với mọi người và mọi người cũng có thể hiểu tôi nói những gì.
    </p>
  </div>
</div>
...
<div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
  <div className="aspect-video w-full">
    <iframe
      className="w-full h-full"
      src="https://www.youtube.com/embed/1RIHaHdERgE"
      title="Mikey Testimonial"
      frameBorder="0"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
      allowFullScreen
    ></iframe>
  ...
  <div className="p-6">
    <div className="flex items-center mb-4">
      ...
      />
      <div>
        <h3 className="font-bold text-[#064088]">Mikey</h3>
        <p className="text-sm text-gray-600">Việt Nam</p>
      </div>
    </div>
    <p className="text-gray-700">
      Mình nghĩ INTERLINK là một nơi rất là tuyệt vời để tờ có thể học được tiếng anh cùng với người bản địa và ngoài ra thì chúng ta có thể học thêm được nhiều ờ kiến thức mới và văn hóa tập tục của người nước ngoài
    </p>
  </div>
</div>
