...
const SPANISHStudentLifeSection = () => {
  const images = [
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#064088] mb-2">
            ¿Cómo es ser estudiante en INTERLINK?
          </h2>
          <p className="text-lg text-gray-700">
            ¡Echa un vistazo a la vida estudiantil, dentro y fuera del aula!
          </p>
        </div>
        <InView
          key={key}
          ...
          <div className="columns-1 sm:columns-2 md:columns-3 gap-4 px-8">
            {images.slice(0, visibleImages).map((imgSrc, index) => (
              ...
              >
                <img
                  src={imgSrc}
                  alt={`Vida de estudiante en INTERLINK ${index + 1}`}
...
export default SPANISHStudentLifeSection;
