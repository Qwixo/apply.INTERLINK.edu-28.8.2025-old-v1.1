      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#064088] mb-2">
            Cuộc sống sinh viên tại INTERLINK như thế nào?
          </h2>
          <p className="text-lg text-gray-700">
            Hãy cùng khám phá cuộc sống sinh viên — cả trong và ngoài lớp học!
          </p>
        </div>
        <InView
          key={key}
          ...
          <div className="columns-1 sm:columns-2 md:columns-3 gap-4 px-8">
            {images.slice(0, visibleImages).map((imgSrc, index) => (
              ...
              >
                <img
                  src={imgSrc}
                  alt={`Cuộc sống sinh viên tại INTERLINK ${index + 1}`}
...
export default VNStudentLifeSection;
