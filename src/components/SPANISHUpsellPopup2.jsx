...
const SPANISHUpsellPopup2 = ({ onClose, showClose = true }) => {
  return (
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="text-center md:text-left md:flex-1">
            ...
            <p className="text-[#3a6ea5] text-lg md:text-xl font-medium leading-snug mb-4">
              ¡Ana, nuestra Directora de Admisiones, estará encantada de ayudarte!
            </p>

            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6">
              Llena este formulario para comenzar tu aplicación y recibir un mensaje personalizado de Ana. Estamos aquí para ayudarte con cualquier duda sobre tus estudios en Estados Unidos. ✈️
            </p>
              ...
              <button
                onClick={() => {
                  ...
                  if (typeof gtag !== 'undefined') {
                    ...
                    setTimeout(openTab, 1000); // fallback
                  } else {
                    openTab();
                  }
                  onClose();
          ...
          {/* Foto (puedes descomentar si decides usarla) */}
          {/*
...
export default SPANISHUpsellPopup2;
