...
const VNUpsellPopup2 = ({ onClose, showClose = true }) => {
  return (
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="text-center md:text-left md:flex-1">
            ...
            <p className="text-[#3a6ea5] text-lg md:text-xl font-medium leading-snug mb-4">
              Ana, Giám đốc Tuyển sinh của chúng tôi, sẽ rất vui được hỗ trợ bạn!
            </p>

            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6">
              Điền vào biểu mẫu này để bắt đầu đơn đăng ký và nhận được tin nhắn cá nhân từ Ana. Chúng tôi luôn sẵn sàng hỗ trợ bạn về bất kỳ thắc mắc nào liên quan đến việc du học Mỹ. ✈️
            </p>
